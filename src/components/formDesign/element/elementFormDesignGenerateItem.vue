<template>
  <template v-if="element">
    ...
    <template v-else>
      <el-form-item :key="element.key" :label="element.label" :prop="element.model">
        ...
        : element.options.options" :key="item.value" :label="item.label" :value="item.value" :style="{
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const handleUploadSuccess = (_re, _file, fileList) => {
      data.value = fileList
    }

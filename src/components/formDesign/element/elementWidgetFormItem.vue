<template>
  <div class="widget-item-container">
    <template v-if="element">
      <div class="widget-view" v-if="element.type == 'echarts-bar'||element.type == 'echarts-line'">
          <template v-if="element.type == 'echarts-line'">
            <EchartsBase type="line" :value="element.options.options" ></EchartsBase>
          </template>
        <template v-else-if="element.type == 'echarts-bar'">
          <EchartsBase type="bar" :value="element.options.options" ></EchartsBase>
        </template>
      </div>
      
      <el-form-item class="widget-view" :key="element.key" v-else
        ...
        <template v-if="element.type === 'radio'">
          <el-radio-group :modelValue="element.options.defaultValue" :style="{ width: element.options.width }"
            ...
            <el-radio v-for="item of element.options.options" :key="item.value" :label="item.label"  :value="item.value" :style="{
        ...
        <template v-if="element.type === 'checkbox'">
          <el-checkbox-group :modelValue="element.options.defaultValue" :style="{ width: element.options.width }"
            :disabled="element.options.disabled">
            <el-checkbox v-for="item of element.options.options" :key="item.value" :label="item.label"  :value="item.value" :style="{
        display: element.options.inline ? 'inline-block' : 'block'
